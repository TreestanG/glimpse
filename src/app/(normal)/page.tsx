...
export default function Home() {
  return (
    <div className=" py-32 sm:py-48 lg:py-60 select-none bg-gradient-to-t overflow-hidden">
      <div 
        className="absolute top-0 right-0 w-[800px] h-[800px] rounded-full blur-3xl transform translate-x-1/3 -translate-y-1/4"
        style={{
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
        <div>
          <h1 className="text-7xl tracking-tight mb-8">Know Their Answer. <br />Before You Ask.</h1>
          <Link href="/signin">
            <button className="bg-white text-black px-4 py-2 rounded-full hover:bg-black/20 transition-all duration-300">
              Get Started
            </button>
          </Link>
        </div>
